...
public:
    ...
    void sqrt(const Tensor<T> &in, const Tensor<T> &out, u64 scale);
    void pow(const Tensor<T> &in, const Tensor<T> &exp, const Tensor<T> &out, u64 scale, std::vector<u64> &out_shape);
    void mul(const Tensor<T> &in, const Tensor<T> &in2, const Tensor<T> &out, u64 scale, std::vector<u64> &out_shape);
    void sub(const Tensor<T> &in, const Tensor<T> &in2, const Tensor<T> &out, u64 scale, std::vector<u64> &out_shape);
    void div_gen(const Tensor<T> &in, const Tensor<T> &in2, const Tensor<T> &out, u64 scale, std::vector<u64> &out_shape);
    void add_gen(const Tensor<T> &in, const Tensor<T> &in2, const Tensor<T> &out, u64 scale, std::vector<u64> &out_shape);
    ...
    void reduceMean(u64 axis, const Tensor<T> &in, Tensor<T> &out, u64 scale);
