...
def dump_model_weights(model, model_dir, model_name):
    ...
    # with open("initializers.bin", "wb") as f:
    #     for initializer in initializers:
    #         print(type(model_name_to_val_dict[initializer]))
    #         print(model_name_to_val_dict[initializer].shape)
    #         f.write(struct.pack('f', model_name_to_val_dict[initializer]))
