...
int main(int argc, char *argv[]) {
    ...
    auto layer0 = FCLayer(bl, bl, config.N, 400, 500000, TruncateType::LocalLRS, TruncateType::StochasticTruncate, false);
    u64 sizes[] = {
        config.N * 500000, 
        config.N * 400, 
    };
    ...
    std::string modelName = "chemistry";    std::cerr << "> Model: " << modelName << std::endl;
