...
/* Variable to read the clear value corresponding to the input variable tmp1 at (396,1-396,41) */
...
/* Variable to read the clear value corresponding to the input variable tmp2 at (399,1-399,36) */
...
start_m();
touch_time();
auto tmp7 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
MatMulCSF2D( (int32_t)1,  (int32_t)784,  (int32_t)128, tmp0, tmp1, tmp7,  (int64_t)12);
ClearMemSecret2( (int32_t)1,  (int32_t)784, tmp0);
ClearMemSecret2( (int32_t)784,  (int32_t)128, tmp1);

auto tmp10 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
MatAddBroadCast2( (int32_t)1,  (int32_t)128, tmp7, tmp2, tmp10);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp7);
ClearMemSecret1( (int32_t)128, tmp2);

auto tmp13 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp10, tmp13);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp10);

auto tmp15 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
MatMulCSF2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp13, tmp3, tmp15,  (int64_t)12);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp3);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp13);

auto tmp18 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
MatAddBroadCast2( (int32_t)1,  (int32_t)128, tmp15, tmp4, tmp18);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp15);
ClearMemSecret1( (int32_t)128, tmp4);

auto tmp21 = make_vector<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp18, tmp21);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp18);

auto tmp23 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10);
MatMulCSF2D( (int32_t)1,  (int32_t)128,  (int32_t)10, tmp21, tmp5, tmp23,  (int64_t)12);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp21);
ClearMemSecret2( (int32_t)128,  (int32_t)10, tmp5);

auto tmp26 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10);
MatAddBroadCast2( (int32_t)1,  (int32_t)10, tmp23, tmp6, tmp26);
ClearMemSecret1( (int32_t)10, tmp6);
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp23);

auto tmp29 = make_vector<uint64_t>( (int32_t)1);
ArgMax1( (int32_t)1,  (int32_t)1,  (int32_t)10, tmp26,  (int32_t)1, tmp29);
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp26);
ClearMemPublic( (int32_t)1);

for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
print_integer(funcReconstruct2PCCons(tmp29[i0], 1));
}
leave_time();
end_m(whichNetwork);
