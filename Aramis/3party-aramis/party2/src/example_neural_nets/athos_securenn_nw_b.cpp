...
auto tmp1 = make_vector<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)16);
...
auto tmp2 = make_vector<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)16,  (int32_t)16);
...
auto tmp3 = make_vector<uint64_t>( (int32_t)256,  (int32_t)100);
...
auto tmp4 = make_vector<uint64_t>( (int32_t)100);
...
auto tmp5 = make_vector<uint64_t>( (int32_t)100,  (int32_t)10);
...
auto tmp10 = make_vector<uint64_t>( (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)16);
Conv2DCSF( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)16,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp8, tmp1,  (int32_t)12, tmp10);
...
auto tmp13 = make_vector<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16);
MaxPool( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)16, tmp10, tmp13);
ClearMemSecret4( (int32_t)1,  (int32_t)24,  (int32_t)24,  (int32_t)16, tmp10);

auto tmp15 = make_vector<uint64_t>( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16);
Relu4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16, tmp13, tmp15);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16, tmp13);

auto tmp17 = make_vector<uint64_t>( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)16);
Conv2DCSF( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16,  (int32_t)5,  (int32_t)5,  (int32_t)16,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1, tmp15, tmp2,  (int32_t)12, tmp17);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)16,  (int32_t)16, tmp2);
ClearMemSecret4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16, tmp15);

auto tmp20 = make_vector<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16);
MaxPool( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)16, tmp17, tmp20);
ClearMemSecret4( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)16, tmp17);

auto tmp22 = make_vector<uint64_t>( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16);
Relu4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16, tmp20, tmp22);
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16, tmp20);

auto tmp24 = make_vector<int32_t>( (int32_t)2);
tmp24[ (int64_t)0] =  (int32_t)-1;
tmp24[ (int64_t)1] =  (int32_t)256;

auto tmp25 = make_vector<uint64_t>( (int32_t)1,  (int32_t)256);
...
ClearMemSecret4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16, tmp22);

auto tmp27 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100);
MatMulCSF2D( (int32_t)1,  (int32_t)256,  (int32_t)100, tmp25, tmp3, tmp27,  (int64_t)12);
ClearMemSecret2( (int32_t)256,  (int32_t)100, tmp3);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp25);

auto tmp30 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100);
MatAddBroadCast2( (int32_t)1,  (int32_t)100, tmp27, tmp4, tmp30);
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp27);
ClearMemSecret1( (int32_t)100, tmp4);

auto tmp33 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100);
Relu2( (int32_t)1,  (int32_t)100, tmp30, tmp33);
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp30);

auto tmp35 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10);
MatMulCSF2D( (int32_t)1,  (int32_t)100,  (int32_t)10, tmp33, tmp5, tmp35,  (int64_t)12);
ClearMemSecret2( (int32_t)100,  (int32_t)10, tmp5);
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp33);
