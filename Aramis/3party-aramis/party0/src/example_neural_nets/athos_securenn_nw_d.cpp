...
auto tmp1 = make_vector<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)5 );
/* Variable to read the clear value corresponding to the input variable tmp1 at (396,1-396,43) */
...
auto tmp2 = make_vector<uint64_t>( (int32_t)980,  (int32_t)100 );
/* Variable to read the clear value corresponding to the input variable tmp2 at (399,1-399,41) */
uint64_t __tmp_in_tmp2;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)980; i0++){
	for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)100; i1++){
		if ((role == CLIENT)) {
			cin >> __tmp_in_tmp2;
			
		}
		tmp2[i0][i1] = (role == CLIENT) ? __tmp_in_tmp2 : 0;
		
	}
	
}

auto tmp3 = make_vector<uint64_t>( (int32_t)100 );
/* Variable to read the clear value corresponding to the input variable tmp3 at (402,1-402,36) */
...
auto tmp4 = make_vector<uint64_t>( (int32_t)100,  (int32_t)10 );
/* Variable to read the clear value corresponding to the input variable tmp4 at (405,1-405,40) */
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)100; i0++){
	for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)10; i1++){
		...
		tmp4[i0][i1] = (role == CLIENT) ? __tmp_in_tmp4 : 0;
		
	}
	
}

auto tmp5 = make_vector<uint64_t>( (int32_t)10 );
...
start_m();
touch_time();
auto tmp6 = make_vector<int32_t>( (int32_t)4 );
tmp6[ (int64_t)0 ] =  (int32_t)-1;
tmp6[ (int64_t)1 ] =  (int32_t)28;
tmp6[ (int64_t)2 ] =  (int32_t)28;
tmp6[ (int64_t)3 ] =  (int32_t)1;

auto tmp7 = make_vector<uint64_t>( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1 );
...
auto tmp9 = make_vector<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)5 );
Conv2DCSF( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)2,  (int32_t)1,  (int32_t)2,  (int32_t)2,  (int32_t)2, tmp7, tmp1,  (int32_t)12, tmp9 );
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1, tmp7 );
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)5, tmp1 );

auto tmp12 = make_vector<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)5 );
Relu4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)5, tmp9, tmp12 );
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)5, tmp9 );

auto tmp14 = make_vector<int32_t>( (int32_t)2 );
tmp14[ (int64_t)0 ] =  (int32_t)-1;
tmp14[ (int64_t)1 ] =  (int32_t)980;

auto tmp15 = make_vector<uint64_t>( (int32_t)1,  (int32_t)980 );
...
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
	for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)980; i11++){
		tmp15[i10][i11] = tmp12[i6][i7][i8][i9];
		i9 = (i9 +  (int64_t)1);
		if ((i9 ==  (int64_t)5)) {
			i9 =  (int64_t)0;
			i8 = (i8 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)5, tmp12 );

auto tmp17 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100 );
MatMulCSF2D( (int32_t)1,  (int32_t)980,  (int32_t)100, tmp15, tmp2, tmp17,  (int64_t)12 );
ClearMemSecret2( (int32_t)1,  (int32_t)980, tmp15 );
ClearMemSecret2( (int32_t)980,  (int32_t)100, tmp2 );

auto tmp20 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100 );
MatAddBroadCast2( (int32_t)1,  (int32_t)100, tmp17, tmp3, tmp20 );
ClearMemSecret1( (int32_t)100, tmp3 );
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp17 );

auto tmp23 = make_vector<uint64_t>( (int32_t)1,  (int32_t)100 );
Relu2( (int32_t)1,  (int32_t)100, tmp20, tmp23 );
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp20 );

auto tmp25 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10 );
MatMulCSF2D( (int32_t)1,  (int32_t)100,  (int32_t)10, tmp23, tmp4, tmp25,  (int64_t)12 );
ClearMemSecret2( (int32_t)1,  (int32_t)100, tmp23 );
ClearMemSecret2( (int32_t)100,  (int32_t)10, tmp4 );

auto tmp28 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10 );
MatAddBroadCast2( (int32_t)1,  (int32_t)10, tmp25, tmp5, tmp28 );
ClearMemSecret1( (int32_t)10, tmp5 );
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp25 );

auto tmp31 = make_vector<uint64_t>( (int32_t)1 );
ArgMax1( (int32_t)1,  (int32_t)1,  (int32_t)10, tmp28,  (int32_t)1, tmp31 );
ClearMemPublic( (int32_t)1 );
ClearMemSecret2( (int32_t)1,  (int32_t)10, tmp28 );

for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
print_integer(funcReconstruct2PCCons(tmp31[i0], 1));
}
