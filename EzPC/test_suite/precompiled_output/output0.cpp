...
/* Variable to read the clear value corresponding to the input variable w at (127,1-127,28) */
uint32_t __tmp_in_w;
if ((role == SERVER)) {
cin >> __tmp_in_w;
}
...
/* Variable to read the clear value corresponding to the input variable x at (128,1-128,28) */
uint32_t __tmp_in_x;
if ((role == SERVER)) {
cin >> __tmp_in_x;
}
...
/* Variable to read the clear value corresponding to the input variable z at (129,1-129,32) */
uint32_t __tmp_in_z;
...
/* Variable to read the clear value corresponding to the input variable a at (130,1-130,37) */
uint32_t __tmp_in_a;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)10; i0++){
...
/* Variable to read the clear value corresponding to the input variable b at (131,1-131,26) */
uint32_t __tmp_in_b;
if ((role == SERVER)) {
cin >> __tmp_in_b;
}
