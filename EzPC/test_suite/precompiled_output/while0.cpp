...
int32_t i =  (int32_t)1;
while ((i <  (int32_t)10)) {
/* Temporary variable for sub-expression on source location: (131,13-131,16) */
int32_t __tac_var78 = (i -  (int32_t)1);
/* Temporary variable for sub-expression on source location: (131,10-131,17) */
share* __tac_var79 = yy[__tac_var78];
/* Temporary variable for sub-expression on source location: (131,20-131,21) */
