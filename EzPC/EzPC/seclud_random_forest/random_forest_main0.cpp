...
const int32_t noOfFeatures =  (int32_t)13;

const int32_t maxDepth =  (int32_t)10;

const int32_t maxDepthInt =  (int32_t)10;

const int32_t noOfTrees =  (int32_t)10;

const int32_t noOfNodes =  (int32_t)1023;

void accessElementOneD(auto& arr, share* idx, auto& result){
result[ (int32_t)0] = put_cons64_gate(ycirc,  (int64_t)0);

int64_t ctr =  (int64_t)0;
for (uint32_t i =  (int32_t)0; i <  (int32_t)13; i++){
/* Temporary variable for sub-expression on source location: (153,14-153,23) */
share* __tac_var78 = result[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (153,37-153,40) */
share* __tac_var79 = put_cons64_gate(ycirc, ctr);
/* Temporary variable for sub-expression on source location: (153,30-153,40) */
share* __tac_var80 = signedequalsbl(idx, __tac_var79);
/* Temporary variable for sub-expression on source location: (153,41-153,47) */
share* __tac_var81 = arr[i];
/* Temporary variable for sub-expression on source location: (153,48-153,50) */
share* __tac_var82 = put_cons64_gate(ycirc,  (int64_t)0);
/* Temporary variable for sub-expression on source location: (153,30-153,50) */
...
void accessElementTwoD(auto& arr, int64_t treeId, share* idx, auto& result, int32_t start, int32_t end){
result[ (int32_t)0] = put_cons64_gate(ycirc,  (int64_t)0);

int64_t ctr = (start +  (int64_t)0);

share* idxcpy = ycirc->PutA2YGate(idx);
for (uint32_t i = start; i < end; i++){
/* Temporary variable for sub-expression on source location: (164,14-164,23) */
share* __tac_var84 = result[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (164,40-164,43) */
share* __tac_var85 = put_cons64_gate(ycirc, ctr);
/* Temporary variable for sub-expression on source location: (164,30-164,43) */
share* __tac_var86 = signedequalsbl(idxcpy, __tac_var85);
/* Temporary variable for sub-expression on source location: (164,44-164,58) */
share* __tac_var87 = arr[treeId][i];
/* Temporary variable for sub-expression on source location: (164,59-164,61) */
share* __tac_var88 = put_cons64_gate(ycirc,  (int64_t)0);
/* Temporary variable for sub-expression on source location: (164,30-164,61) */
...
share* currentIndex = put_cons64_gate(acirc,  (int64_t)0);
...
currentSharedFeatureChoice[ (int32_t)0] = put_cons64_gate(ycirc,  (int64_t)0);
...
int32_t startIdx =  (int32_t)0;

int32_t endIdx =  (int32_t)0;
for (uint32_t i =  (int32_t)0; i <  (int32_t)10; i++){
currentIndex = put_cons64_gate(acirc,  (int64_t)0);
...
/* Temporary variable for sub-expression on source location: (198,27-198,56) */
share* __tac_var90 = currentSharedFeatureChoice[ (int32_t)0];
accessElementOneD(query, __tac_var90, currentSharedQueryValue);
/* Temporary variable for sub-expression on source location: (199,17-199,42) */
share* __tac_var91 = currentSharedThreshold[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (199,45-199,71) */
share* __tac_var92 = currentSharedQueryValue[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (199,17-199,71) */
share* __tac_var93 = signedgtbl(__tac_var91, __tac_var92);
/* Temporary variable for sub-expression on source location: (199,73-199,75) */
share* __tac_var94 = put_cons64_gate(ycirc,  (int64_t)1);
/* Temporary variable for sub-expression on source location: (199,76-199,78) */
share* __tac_var95 = put_cons64_gate(ycirc,  (int64_t)2);
/* Temporary variable for sub-expression on source location: (199,16-199,78) */
share* __tac_var96 = ycirc->PutMUXGate(__tac_var94, __tac_var95, __tac_var93);
leftOrRight = acirc->PutY2AGate(__tac_var96, bcirc);
/* Temporary variable for sub-expression on source location: (200,11-200,24) */
int32_t __tac_var97 = ( (int32_t)10 -  (int32_t)1);
for (uint32_t j =  (int32_t)1; j < __tac_var97; j++){
/* Temporary variable for sub-expression on source location: (202,37-202,39) */
share* __tac_var98 = put_cons64_gate(acirc,  (int64_t)2);
/* Temporary variable for sub-expression on source location: (202,19-202,39) */
share* __tac_var99 = acirc->PutMULGate(currentIndex, __tac_var98);
currentIndex = acirc->PutADDGate(__tac_var99, leftOrRight);
/* Temporary variable for sub-expression on source location: (203,14-203,23) */
int32_t __tac_var100 = pow( (int32_t)2, j);
startIdx = (__tac_var100 -  (int32_t)1);
/* Temporary variable for sub-expression on source location: (204,19-204,22) */
int32_t __tac_var101 = (j +  (int32_t)1);
/* Temporary variable for sub-expression on source location: (204,12-204,23) */
int32_t __tac_var102 = pow( (int32_t)2, __tac_var101);
endIdx = (__tac_var102 -  (int32_t)1);
...
/* Temporary variable for sub-expression on source location: (207,28-207,57) */
share* __tac_var103 = currentSharedFeatureChoice[ (int32_t)0];
accessElementOneD(query, __tac_var103, currentSharedQueryValue);
/* Temporary variable for sub-expression on source location: (208,18-208,43) */
share* __tac_var104 = currentSharedThreshold[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (208,46-208,72) */
share* __tac_var105 = currentSharedQueryValue[ (int32_t)0];
/* Temporary variable for sub-expression on source location: (208,18-208,72) */
share* __tac_var106 = signedgtbl(__tac_var104, __tac_var105);
/* Temporary variable for sub-expression on source location: (208,74-208,76) */
share* __tac_var107 = __tac_var94;
/* Temporary variable for sub-expression on source location: (208,77-208,79) */
share* __tac_var108 = __tac_var95;
/* Temporary variable for sub-expression on source location: (208,17-208,79) */
share* __tac_var109 = ycirc->PutMUXGate(__tac_var94, __tac_var95, __tac_var106);
leftOrRight = acirc->PutY2AGate(__tac_var109, bcirc);
}
/* Temporary variable for sub-expression on source location: (211,36-211,38) */
share* __tac_var110 = put_cons64_gate(acirc,  (int64_t)2);
/* Temporary variable for sub-expression on source location: (211,18-211,38) */
share* __tac_var111 = acirc->PutMULGate(currentIndex, __tac_var110);
currentIndex = acirc->PutADDGate(__tac_var111, leftOrRight);
/* Temporary variable for sub-expression on source location: (212,20-212,33) */
int32_t __tac_var112 = __tac_var97;
/* Temporary variable for sub-expression on source location: (212,13-212,34) */
int32_t __tac_var113 = pow( (int32_t)2, __tac_var97);
startIdx = (__tac_var113 -  (int32_t)1);
/* Temporary variable for sub-expression on source location: (213,11-213,30) */
int32_t __tac_var114 = pow( (int32_t)2,  (int32_t)10);
endIdx = (__tac_var114 -  (int32_t)1);
accessElementTwoD(modelThresholdValue, i, currentIndex, currentSharedThreshold, startIdx, endIdx);
...
auto modelFeatureChoice = make_vector<share*>( (int32_t)10,  (int32_t)1023);

auto modelThresholdValue = make_vector<share*>( (int32_t)10,  (int32_t)1023);

auto inferenceResult = make_vector<share*>( (int32_t)10);

share* finalResult = put_cons64_gate(ycirc,  (int64_t)0);
for (uint32_t i =  (int32_t)0; i <  (int32_t)13; i++){
...
/* Variable to read the clear value corresponding to the input variable temp at (230,2-230,31) */
uint64_t __tmp_in_temp;
if ((role == CLIENT)) {
cin >> __tmp_in_temp;
}
temp = (role == CLIENT) ? ycirc->PutINGate(__tmp_in_temp, bitlen, CLIENT) : ycirc->PutDummyINGate(bitlen);
inferenceQuery[i] = temp;
}
for (uint32_t i =  (int32_t)0; i <  (int32_t)10; i++){
for (uint32_t j =  (int32_t)0; j <  (int32_t)1023; j++){

share* temp;
if ((role == SERVER)) {
cout << ("Input temp:") << endl;
}
/* Variable to read the clear value corresponding to the input variable temp at (239,3-239,32) */
uint64_t __tmp_in_temp;
if ((role == SERVER)) {
cin >> __tmp_in_temp;
}
temp = (role == SERVER) ? ycirc->PutINGate(__tmp_in_temp, bitlen, SERVER) : ycirc->PutDummyINGate(bitlen);
...
/* Variable to read the clear value corresponding to the input variable temp at (244,3-244,32) */
uint64_t __tmp_in_temp;
if ((role == SERVER)) {
cin >> __tmp_in_temp;
}
...
for (uint32_t i =  (int32_t)0; i <  (int32_t)10; i++){
/* Temporary variable for sub-expression on source location: (252,16-252,27) */
share* __tac_var115 = acirc->PutY2AGate(finalResult, bcirc);
/* Temporary variable for sub-expression on source location: (252,33-252,51) */
share* __tac_var116 = inferenceResult[i];
/* Temporary variable for sub-expression on source location: (252,33-252,51) */
share* __tac_var117 = acirc->PutY2AGate(__tac_var116, bcirc);
/* Temporary variable for sub-expression on source location: (252,16-252,51) */
share* __tac_var118 = acirc->PutADDGate(__tac_var115, __tac_var117);
finalResult = ycirc->PutA2YGate(__tac_var118);
}
add_print_msg_to_output_queue(out_q, "Value of finalResult:", CLIENT, cout);
add_to_output_queue(out_q, ycirc->PutOUTGate(finalResult, CLIENT), CLIENT, cout);
party->ExecCircuit();
