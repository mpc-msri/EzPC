...
auto x = make_vector<int32_t>( (int32_t)2,  (int32_t)2);
cout << ("Input x:") << endl;
...
Integer z = Integer(bitlen, (x[ (int32_t)1][ (int32_t)0] + y), PUBLIC).operator*(w).operator-(Integer(bitlen,  (int32_t)100, PUBLIC));
cout << ("Value of z:") << endl;
cout << (z.reveal<int32_t>(ALICE)) << endl;
