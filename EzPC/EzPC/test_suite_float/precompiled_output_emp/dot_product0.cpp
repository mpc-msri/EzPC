...
cout << ("Value of ((acc) >_baba (b)) ?_baba (<public ~> baba> (1)) : (<public ~> baba> (0)):") << endl;
cout << ( If(b.less_than(acc), Integer(bitlen,  (int32_t)1, PUBLIC), Integer(bitlen,  (int32_t)0, PUBLIC)).reveal<int32_t>(ALICE)) << endl;
