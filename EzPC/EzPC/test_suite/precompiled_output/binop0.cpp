...
/* Temporary variable for sub-expression on source location: (170,7-170,9) */
share* __tac_var78 = put_cons32_gate(acirc,  (uint32_t)4);
c = unsigneddival(b, __tac_var78);
d = ( (uint32_t)10 %  (uint32_t)4);
/* Temporary variable for sub-expression on source location: (172,5-172,6) */
share* __tac_var79 = ycirc->PutA2YGate(b);
/* Temporary variable for sub-expression on source location: (172,5-172,10) */
...
/* Temporary variable for sub-expression on source location: (180,5-180,17) */
uint32_t __tac_var96 = (0 || 0);
e = put_cons1_gate(ycirc, __tac_var96);
/* Temporary variable for sub-expression on source location: (181,5-181,15) */
