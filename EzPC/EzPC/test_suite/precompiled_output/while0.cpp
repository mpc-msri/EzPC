...
auto yy = make_vector<share*>( (int32_t)10);
yy[ (int32_t)0] = put_cons32_gate(acirc,  (int32_t)0);

int32_t i =  (int32_t)1;
while ((i <  (int32_t)10)) {
/* Temporary variable for sub-expression on source location: (171,13-171,16) */
int32_t __tac_var78 = (i -  (int32_t)1);
/* Temporary variable for sub-expression on source location: (171,10-171,17) */
share* __tac_var79 = yy[__tac_var78];
/* Temporary variable for sub-expression on source location: (171,20-171,21) */
share* __tac_var80 = put_cons32_gate(acirc,  (int32_t)1);
yy[i] = acirc->PutADDGate(__tac_var79, __tac_var80);
i = (i +  (int32_t)1);
}

/* Temporary variable for sub-expression on source location: (174,13-174,18) */
