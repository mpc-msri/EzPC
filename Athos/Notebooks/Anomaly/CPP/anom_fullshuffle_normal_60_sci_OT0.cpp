...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)64,  (int32_t)64,  (int32_t)1,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9067,1-9067,44) */
...
Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)64, (int32_t)1, (int32_t)1,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}
...
/* Variable to read the clear value corresponding to the input variable tmp2 at (9070,1-9070,34) */
...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)3);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9073,1-9073,33) */
uint64_t __tmp_in_tmp3;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)3; i0++){
if ((party == SERVER)) {
cin >> __tmp_in_tmp3;
}
Arr1DIdxRowM(tmp3, (int32_t)3,i0) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)64,  (int32_t)1,  (int32_t)6400);
...
i2 =  (int64_t)0;
i3 =  (int64_t)0;
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)64; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)1; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)6400; i6++){
Arr3DIdxRowM(tmp5, (int32_t)64, (int32_t)1, (int32_t)6400,i4,i5,i6) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)80)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)6400);
...
Arr3DIdxRowM(tmp6, (int32_t)1, (int32_t)64, (int32_t)6400,i8,i7,i9) = Arr3DIdxRowM(tmp5, (int32_t)64, (int32_t)1, (int32_t)6400,i7,i8,i9);
}
}
}

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80);
...
i11 =  (int64_t)0;
i12 =  (int64_t)0;
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)1; i13++){
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)64; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)80; i15++){
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)80; i16++){
Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i13,i14,i15,i16) = Arr3DIdxRowM(tmp6, (int32_t)1, (int32_t)64, (int32_t)6400,i10,i11,i12);
i12 = (i12 +  (int64_t)1);
if ((i12 ==  (int64_t)6400)) {
i12 =  (int64_t)0;
i11 = (i11 +  (int64_t)1);
...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
...
i19 =  (int64_t)0;
i20 =  (int64_t)0;
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)1; i21++){
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)64; i24++){
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)80; i22++){
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)80; i23++){
Arr4DIdxRowM(tmp8, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i21,i22,i23,i24) = Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i17,i18,i19,i20);
i20 = (i20 +  (int64_t)1);
if ((i20 ==  (int64_t)80)) {
i20 =  (int64_t)0;
i19 = (i19 +  (int64_t)1);
...
i27 =  (int64_t)0;
i28 =  (int64_t)0;
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)64; i32++){
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)64; i31++){
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)1; i29++){
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)1; i30++){
Arr4DIdxRowM(tmp9, (int32_t)1, (int32_t)1, (int32_t)64, (int32_t)64,i29,i30,i31,i32) = Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)64, (int32_t)1, (int32_t)1,i25,i26,i27,i28);
i28 = (i28 +  (int64_t)1);
if ((i28 ==  (int64_t)1)) {
i28 =  (int64_t)0;
i27 = (i27 +  (int64_t)1);
...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
Conv2DGroupWrapper( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64,  (int32_t)1,  (int32_t)1,  (int32_t)64,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp8, tmp9, tmp10);
...
int64_t i33;
i33 =  (int64_t)0;
for (uint32_t i34 =  (int32_t)0; i34 <  (int32_t)1; i34++){
...
Arr4DIdxRowM(tmp11, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i34,i35,i36,i37) = Arr1DIdxRowM(tmp2, (int32_t)64,i33);
i33 = (i33 +  (int64_t)1);
}
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
...
Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp10, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i0,i1,i2,i3), Arr4DIdxRowM(tmp11, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i0, (int32_t)0, (int32_t)0,i3));
}
}
}
}

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80);
...
for (uint32_t i44 =  (int32_t)0; i44 <  (int32_t)80; i44++){
for (uint32_t i45 =  (int32_t)0; i45 <  (int32_t)80; i45++){
for (uint32_t i43 =  (int32_t)0; i43 <  (int32_t)64; i43++){
Arr4DIdxRowM(tmp13, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i42,i43,i44,i45) = Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i38,i39,i40,i41);
i41 = (i41 +  (int64_t)1);
if ((i41 ==  (int64_t)64)) {
i41 =  (int64_t)0;
i40 = (i40 +  (int64_t)1);
...
ScaleDown4( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80, tmp13,  (int32_t)23);
EndComputation();
}