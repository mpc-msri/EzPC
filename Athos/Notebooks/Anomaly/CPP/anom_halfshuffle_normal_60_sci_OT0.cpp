...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80);
/* Variable to read the clear value corresponding to the input variable tmp0 at (9064,1-9064,45) */
uint64_t __tmp_in_tmp0;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)64; i1++){
for (uint32_t i2 =  (uint32_t)0; i2 <  (int32_t)80; i2++){
for (uint32_t i3 =  (uint32_t)0; i3 <  (int32_t)80; i3++){
if ((party == CLIENT)) {
__tmp_in_tmp0 = rand() ;
}
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)32,  (int32_t)1,  (int32_t)3,  (int32_t)3);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9067,1-9067,43) */
...
Arr4DIdxRowM(tmp1, (int32_t)32, (int32_t)1, (int32_t)3, (int32_t)3,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)64,  (int32_t)64,  (int32_t)1,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9070,1-9070,44) */
...
Arr4DIdxRowM(tmp2, (int32_t)64, (int32_t)64, (int32_t)1, (int32_t)1,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
}
}
...
/* Variable to read the clear value corresponding to the input variable tmp3 at (9073,1-9073,34) */
...
/* Variable to read the clear value corresponding to the input variable tmp4 at (9076,1-9076,33) */
...
/* Variable to read the clear value corresponding to the input variable tmp5 at (9079,1-9079,33) */
...
float _init_comm = get_commun() ;

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)32,  (int32_t)2,  (int32_t)6400);
...
i2 =  (int64_t)0;
i3 =  (int64_t)0;
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)32; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)2; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)6400; i6++){
Arr3DIdxRowM(tmp6, (int32_t)32, (int32_t)2, (int32_t)6400,i4,i5,i6) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)80)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)2,  (int32_t)32,  (int32_t)6400);
...
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)2; i8++){
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)6400; i9++){
Arr3DIdxRowM(tmp7, (int32_t)2, (int32_t)32, (int32_t)6400,i8,i7,i9) = Arr3DIdxRowM(tmp6, (int32_t)32, (int32_t)2, (int32_t)6400,i7,i8,i9);
}
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)2,  (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80);
...
i11 =  (int64_t)0;
i12 =  (int64_t)0;
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)2; i13++){
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)1; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)32; i15++){
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)80; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)80; i17++){
Arr5DIdxRowM(tmp8, (int32_t)2, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i13,i14,i15,i16,i17) = Arr3DIdxRowM(tmp7, (int32_t)2, (int32_t)32, (int32_t)6400,i10,i11,i12);
i12 = (i12 +  (int64_t)1);
if ((i12 ==  (int64_t)6400)) {
i12 =  (int64_t)0;
i11 = (i11 +  (int64_t)1);
...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80);
...
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)80; i21++){
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)80; i22++){
Arr4DIdxRowM(tmp9, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i19,i20,i21,i22) = Arr5DIdxRowM(tmp8, (int32_t)2, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i18,i19,i20,i21,i22);
}
}
}
}

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80);
...
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)32; i25++){
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)80; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)80; i27++){
Arr4DIdxRowM(tmp10, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i24,i25,i26,i27) = Arr5DIdxRowM(tmp8, (int32_t)2, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i23,i24,i25,i26,i27);
}
}
}
}

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)32);
...
i30 =  (int64_t)0;
i31 =  (int64_t)0;
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)1; i32++){
for (uint32_t i35 =  (int32_t)0; i35 <  (int32_t)32; i35++){
for (uint32_t i33 =  (int32_t)0; i33 <  (int32_t)80; i33++){
for (uint32_t i34 =  (int32_t)0; i34 <  (int32_t)80; i34++){
Arr4DIdxRowM(tmp11, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)32,i32,i33,i34,i35) = Arr4DIdxRowM(tmp10, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i28,i29,i30,i31);
i31 = (i31 +  (int64_t)1);
if ((i31 ==  (int64_t)80)) {
i31 =  (int64_t)0;
i30 = (i30 +  (int64_t)1);
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)32);
...
i38 =  (int64_t)0;
i39 =  (int64_t)0;
for (uint32_t i43 =  (int32_t)0; i43 <  (int32_t)32; i43++){
for (uint32_t i42 =  (int32_t)0; i42 <  (int32_t)1; i42++){
for (uint32_t i40 =  (int32_t)0; i40 <  (int32_t)3; i40++){
for (uint32_t i41 =  (int32_t)0; i41 <  (int32_t)3; i41++){
Arr4DIdxRowM(tmp12, (int32_t)3, (int32_t)3, (int32_t)1, (int32_t)32,i40,i41,i42,i43) = Arr4DIdxRowM(tmp1, (int32_t)32, (int32_t)1, (int32_t)3, (int32_t)3,i36,i37,i38,i39);
i39 = (i39 +  (int64_t)1);
if ((i39 ==  (int64_t)3)) {
i39 =  (int64_t)0;
i38 = (i38 +  (int64_t)1);
...
uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)32);
Conv2DGroupWrapper( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)32,  (int32_t)3,  (int32_t)3,  (int32_t)32,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)32, tmp11, tmp12, tmp13);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80);
...
i46 =  (int64_t)0;
i47 =  (int64_t)0;
for (uint32_t i48 =  (int32_t)0; i48 <  (int32_t)1; i48++){
for (uint32_t i50 =  (int32_t)0; i50 <  (int32_t)80; i50++){
for (uint32_t i51 =  (int32_t)0; i51 <  (int32_t)80; i51++){
for (uint32_t i49 =  (int32_t)0; i49 <  (int32_t)32; i49++){
Arr4DIdxRowM(tmp14, (int32_t)1, (int32_t)32, (int32_t)80, (int32_t)80,i48,i49,i50,i51) = Arr4DIdxRowM(tmp13, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)32,i44,i45,i46,i47);
i47 = (i47 +  (int64_t)1);
if ((i47 ==  (int64_t)32)) {
i47 =  (int64_t)0;
i46 = (i46 +  (int64_t)1);
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80);
ScaleDown4( (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80, tmp14,  (int32_t)23);

uint64_t _time1 = get_time(counter) ;
float _comm1 = get_commun() - _init_comm;

printf("\n--------------------------------------------\nCHECKPOINT ADD 1 --> Time = %lld, Comm = %f\n--------------------------------------\n", _time1, _comm1) ;

counter = get_counter() ;
_init_comm = get_commun() ;


int32_t tmp15 =  (int32_t)1;
Concat2T444( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80,  (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80, tmp9,  (int32_t)1,  (int32_t)32,  (int32_t)80,  (int32_t)80, tmp14, tmp15, tmp16);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
...
i54 =  (int64_t)0;
i55 =  (int64_t)0;
for (uint32_t i56 =  (int32_t)0; i56 <  (int32_t)1; i56++){
for (uint32_t i59 =  (int32_t)0; i59 <  (int32_t)64; i59++){
for (uint32_t i57 =  (int32_t)0; i57 <  (int32_t)80; i57++){
for (uint32_t i58 =  (int32_t)0; i58 <  (int32_t)80; i58++){
Arr4DIdxRowM(tmp17, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i56,i57,i58,i59) = Arr4DIdxRowM(tmp16, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i52,i53,i54,i55);
i55 = (i55 +  (int64_t)1);
if ((i55 ==  (int64_t)80)) {
i55 =  (int64_t)0;
i54 = (i54 +  (int64_t)1);
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)64,  (int32_t)64);
...
i62 =  (int64_t)0;
i63 =  (int64_t)0;
for (uint32_t i67 =  (int32_t)0; i67 <  (int32_t)64; i67++){
for (uint32_t i66 =  (int32_t)0; i66 <  (int32_t)64; i66++){
for (uint32_t i64 =  (int32_t)0; i64 <  (int32_t)1; i64++){
for (uint32_t i65 =  (int32_t)0; i65 <  (int32_t)1; i65++){
Arr4DIdxRowM(tmp18, (int32_t)1, (int32_t)1, (int32_t)64, (int32_t)64,i64,i65,i66,i67) = Arr4DIdxRowM(tmp2, (int32_t)64, (int32_t)64, (int32_t)1, (int32_t)1,i60,i61,i62,i63);
i63 = (i63 +  (int64_t)1);
if ((i63 ==  (int64_t)1)) {
i63 =  (int64_t)0;
i62 = (i62 +  (int64_t)1);
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
Conv2DGroupWrapper( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64,  (int32_t)1,  (int32_t)1,  (int32_t)64,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp17, tmp18, tmp19);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64);
...
int64_t i68;
i68 =  (int64_t)0;
for (uint32_t i69 =  (int32_t)0; i69 <  (int32_t)1; i69++){
for (uint32_t i70 =  (int32_t)0; i70 <  (int32_t)1; i70++){
for (uint32_t i71 =  (int32_t)0; i71 <  (int32_t)1; i71++){
for (uint32_t i72 =  (int32_t)0; i72 <  (int32_t)64; i72++){
Arr4DIdxRowM(tmp20, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i69,i70,i71,i72) = Arr1DIdxRowM(tmp3, (int32_t)64,i68);
i68 = (i68 +  (int64_t)1);
}
}
}
}
ScaleUp4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64, tmp20,  (int32_t)23);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)80; i1++){
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)80; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)64; i3++){
Arr4DIdxRowM(tmp21, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp19, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i0,i1,i2,i3), Arr4DIdxRowM(tmp20, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i0, (int32_t)0, (int32_t)0,i3));
}
}
}
}

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80);
...
i75 =  (int64_t)0;
i76 =  (int64_t)0;
for (uint32_t i77 =  (int32_t)0; i77 <  (int32_t)1; i77++){
for (uint32_t i79 =  (int32_t)0; i79 <  (int32_t)80; i79++){
for (uint32_t i80 =  (int32_t)0; i80 <  (int32_t)80; i80++){
for (uint32_t i78 =  (int32_t)0; i78 <  (int32_t)64; i78++){
Arr4DIdxRowM(tmp22, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i77,i78,i79,i80) = Arr4DIdxRowM(tmp21, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i73,i74,i75,i76);
i76 = (i76 +  (int64_t)1);
if ((i76 ==  (int64_t)64)) {
i76 =  (int64_t)0;
i75 = (i75 +  (int64_t)1);
...
ScaleDown4( (int32_t)1,  (int32_t)64,  (int32_t)80,  (int32_t)80, tmp22,  (int32_t)23);

uint64_t _time2 = get_time(counter) ;
float _comm2 = get_commun() - _init_comm;

printf("\n--------------------------------------------\nCHECKPOINT ADD 2 --> Time = %lld, Comm = %f\n--------------------------------------\n", _time2, _comm2) ;
