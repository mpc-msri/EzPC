...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)64,  (int32_t)1,  (int32_t)3,  (int32_t)3);
...
Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)1, (int32_t)3, (int32_t)3,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64);
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)80; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)80; i6++){
Arr4DIdxRowM(tmp4, (int32_t)1, (int32_t)80, (int32_t)80, (int32_t)64,i4,i5,i6,i7) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)80, (int32_t)80,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)80)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)64);
...
Arr4DIdxRowM(tmp5, (int32_t)3, (int32_t)3, (int32_t)1, (int32_t)64,i12,i13,i14,i15) = Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)1, (int32_t)3, (int32_t)3,i8,i9,i10,i11);
i11 = (i11 +  (int64_t)1);
if ((i11 ==  (int64_t)3)) {
i11 =  (int64_t)0;
i10 = (i10 +  (int64_t)1);
...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64);
Conv2DGroupWrapper( (int32_t)1,  (int32_t)80,  (int32_t)80,  (int32_t)64,  (int32_t)3,  (int32_t)3,  (int32_t)64,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)64, tmp4, tmp5, tmp6);

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)78,  (int32_t)78);
...
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)78; i22++){
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)78; i23++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)64; i21++){
Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)64, (int32_t)78, (int32_t)78,i20,i21,i22,i23) = Arr4DIdxRowM(tmp6, (int32_t)1, (int32_t)78, (int32_t)78, (int32_t)64,i16,i17,i18,i19);
i19 = (i19 +  (int64_t)1);
if ((i19 ==  (int64_t)64)) {
i19 =  (int64_t)0;
i18 = (i18 +  (int64_t)1);
...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64);
...
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)78; i29++){
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)78; i30++){
Arr4DIdxRowM(tmp8, (int32_t)1, (int32_t)78, (int32_t)78, (int32_t)64,i28,i29,i30,i31) = Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)64, (int32_t)78, (int32_t)78,i24,i25,i26,i27);
i27 = (i27 +  (int64_t)1);
if ((i27 ==  (int64_t)78)) {
i27 =  (int64_t)0;
i26 = (i26 +  (int64_t)1);
...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)64,  (int32_t)64);
...
i34 =  (int64_t)0;
i35 =  (int64_t)0;
for (uint32_t i39 =  (int32_t)0; i39 <  (int32_t)64; i39++){
for (uint32_t i38 =  (int32_t)0; i38 <  (int32_t)64; i38++){
for (uint32_t i36 =  (int32_t)0; i36 <  (int32_t)1; i36++){
for (uint32_t i37 =  (int32_t)0; i37 <  (int32_t)1; i37++){
Arr4DIdxRowM(tmp9, (int32_t)1, (int32_t)1, (int32_t)64, (int32_t)64,i36,i37,i38,i39) = Arr4DIdxRowM(tmp2, (int32_t)64, (int32_t)64, (int32_t)1, (int32_t)1,i32,i33,i34,i35);
i35 = (i35 +  (int64_t)1);
if ((i35 ==  (int64_t)1)) {
i35 =  (int64_t)0;
i34 = (i34 +  (int64_t)1);
...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64);
ScaleDown4( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64, tmp8,  (int32_t)23);
...
Conv2DGroupWrapper( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64,  (int32_t)1,  (int32_t)1,  (int32_t)64,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp8, tmp9, tmp10);

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64);
...
for (uint32_t i43 =  (int32_t)0; i43 <  (int32_t)1; i43++){
for (uint32_t i44 =  (int32_t)0; i44 <  (int32_t)64; i44++){
Arr4DIdxRowM(tmp11, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i41,i42,i43,i44) = Arr1DIdxRowM(tmp3, (int32_t)64,i40);
i40 = (i40 +  (int64_t)1);
}
}
}
}
ScaleUp4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64, tmp11,  (int32_t)23);

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)78,  (int32_t)78,  (int32_t)64);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)78; i1++){
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)78; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)64; i3++){
Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)78, (int32_t)78, (int32_t)64,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp10, (int32_t)1, (int32_t)78, (int32_t)78, (int32_t)64,i0,i1,i2,i3), Arr4DIdxRowM(tmp11, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i0, (int32_t)0, (int32_t)0,i3));
}
}
}
}

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)78,  (int32_t)78);
...
for (uint32_t i51 =  (int32_t)0; i51 <  (int32_t)78; i51++){
for (uint32_t i52 =  (int32_t)0; i52 <  (int32_t)78; i52++){
for (uint32_t i50 =  (int32_t)0; i50 <  (int32_t)64; i50++){
Arr4DIdxRowM(tmp13, (int32_t)1, (int32_t)64, (int32_t)78, (int32_t)78,i49,i50,i51,i52) = Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)78, (int32_t)78, (int32_t)64,i45,i46,i47,i48);
i48 = (i48 +  (int64_t)1);
if ((i48 ==  (int64_t)64)) {
i48 =  (int64_t)0;
i47 = (i47 +  (int64_t)1);
...
ScaleDown4( (int32_t)1,  (int32_t)64,  (int32_t)78,  (int32_t)78, tmp13,  (int32_t)23);
