...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)32,  (int32_t)128,  (int32_t)128);
...
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)32, (int32_t)128, (int32_t)128,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)32,  (int32_t)1,  (int32_t)6,  (int32_t)6);
...
Arr4DIdxRowM(tmp1, (int32_t)32, (int32_t)1, (int32_t)6, (int32_t)6,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}
...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)128,  (int32_t)128,  (int32_t)32);
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)32; i7++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
Arr4DIdxRowM(tmp3, (int32_t)1, (int32_t)128, (int32_t)128, (int32_t)32,i4,i5,i6,i7) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)32, (int32_t)128, (int32_t)128,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)128)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)6,  (int32_t)6,  (int32_t)1,  (int32_t)32);
...
Arr4DIdxRowM(tmp4, (int32_t)6, (int32_t)6, (int32_t)1, (int32_t)32,i12,i13,i14,i15) = Arr4DIdxRowM(tmp1, (int32_t)32, (int32_t)1, (int32_t)6, (int32_t)6,i8,i9,i10,i11);
i11 = (i11 +  (int64_t)1);
if ((i11 ==  (int64_t)6)) {
i11 =  (int64_t)0;
i10 = (i10 +  (int64_t)1);
...
Conv2DWinoWrapper( (int32_t)2,  (int32_t)5,  (int32_t)1,  (int32_t)128,  (int32_t)128,  (int32_t)32,  (int32_t)32,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)32, tmp3, tmp4, tmp5);
