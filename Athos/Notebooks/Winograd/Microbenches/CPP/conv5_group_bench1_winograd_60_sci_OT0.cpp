...
void Conv2DWinoSingleCOT(int32_t m, int32_t r, int32_t N, int32_t H, int32_t W, int32_t CI, int32_t CO, int32_t zPadHLeft, int32_t zPadHRight, int32_t zPadWLeft, int32_t zPadWRight, uint64_t* inputArr, uint64_t* transformedFilter, uint64_t* outArr){

int32_t n = ((m + r) -  (int32_t)1);

int32_t truH = ((H + zPadHLeft) + zPadHRight);

int32_t truW = ((W + zPadWLeft) + zPadWRight);

int32_t outH = ((truH - r) +  (int32_t)1);

int32_t outW = ((truW - r) +  (int32_t)1);

uint64_t* truInputImg = make_array<uint64_t>(N, CI, truH, truW);
for (uint32_t i1 =  (int32_t)0; i1 < N; i1++){
for (uint32_t i2 =  (int32_t)0; i2 < CI; i2++){
for (uint32_t i3 =  (int32_t)0; i3 < truH; i3++){
for (uint32_t i4 =  (int32_t)0; i4 < truW; i4++){
if (((((zPadHLeft <= i3) && (i3 < (zPadHLeft + H))) && (zPadWLeft <= i4)) && (i4 < (zPadWLeft + W)))) {
Arr4DIdxRowM(truInputImg,N,CI,truH,truW,i1,i2,i3,i4) = Arr4DIdxRowM(inputArr,N,H,W,CI,i1,(i3 - zPadHLeft),(i4 - zPadWLeft),i2);
} else {
Arr4DIdxRowM(truInputImg,N,CI,truH,truW,i1,i2,i3,i4) = funcSSCons( (int64_t)0);
}
}
}
}
...
int32_t TW;
if (((((truH - r) +  (int32_t)1) % m) ==  (int32_t)0)) {
TH = (((truH - r) +  (int32_t)1) / m);
} else {
TH = ((((truH - r) +  (int32_t)1) / m) +  (int32_t)1);
}
if (((((truW - r) +  (int32_t)1) % m) ==  (int32_t)0)) {
TW = (((truW - r) +  (int32_t)1) / m);
} else {
TW = ((((truW - r) +  (int32_t)1) / m) +  (int32_t)1);
}

uint64_t* inputTiles = make_array<uint64_t>(N, CI, TH, TW, n, n);
for (uint32_t i1 =  (int32_t)0; i1 < N; i1++){
for (uint32_t i2 =  (int32_t)0; i2 < CI; i2++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){

uint64_t* inputBlock = make_array<uint64_t>(n, n);

uint64_t* inputTransformed = make_array<uint64_t>(n, n);
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
...
Arr2DIdxRowM(inputBlock,n,n,i,j) = Arr4DIdxRowM(truInputImg,N,CI,truH,truW,i1,i2,indH,indW);
} else {
Arr2DIdxRowM(inputBlock,n,n,i,j) = funcSSCons( (int64_t)0);
}
}
}
if ((r ==  (int32_t)3)) {
...
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr6DIdxRowM(inputTiles,N,CI,TH,TW,n,n,i1,i2,th,tw,i,j) = Arr2DIdxRowM(inputTransformed,n,n,i,j);
}
}
...
int32_t s2 = (((CO * CI) * n) * n);

uint64_t* mul1 = make_array<uint64_t>(s1, s2);

uint64_t* mul2 = make_array<uint64_t>(s2,  (int32_t)1);

uint64_t* mulout = make_array<uint64_t>(s1, s2);
for (uint32_t co =  (int32_t)0; co < CO; co++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
for (uint32_t ci =  (int32_t)0; ci < CI; ci++){
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(mul1,s1,s2,((th * TW) + tw),((((((co * CI) * n) * n) + ((ci * n) * n)) + (i * n)) + j)) = Arr6DIdxRowM(inputTiles,N,CI,TH,TW,n,n, (int32_t)0,ci,th,tw,i,j);
Arr2DIdxRowM(mul2,s2, (int32_t)1,((((((co * CI) * n) * n) + ((ci * n) * n)) + (i * n)) + j), (int32_t)0) = Arr4DIdxRowM(transformedFilter,((m + r) -  (int32_t)1),((m + r) -  (int32_t)1),CI,CO,i,j,ci,co);
}
}
}
}
...
WinogradHadamard(s1, s2,  (int32_t)1, mul1, mul2, mulout, 0);
ClearMemSecret2(s1, s2, mul1);
ClearMemSecret2(s1, s2, mul2);

uint64_t* outputTiles = make_array<uint64_t>(CO, CI, TH, TW, m, m);

uint64_t* reducedTiles = make_array<uint64_t>(CO, TH, TW, m, m);
for (uint32_t i2 =  (int32_t)0; i2 < CO; i2++){
for (uint32_t i3 =  (int32_t)0; i3 < CI; i3++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){

uint64_t* outputBlock = make_array<uint64_t>(n, n);

uint64_t* outputTransformed = make_array<uint64_t>(m, m);
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(outputBlock,n,n,i,j) = Arr2DIdxRowM(mulout,s1,s2,((th * TW) + tw),((((((i2 * CI) * n) * n) + ((i3 * n) * n)) + (i * n)) + j));
}
}
if ((r ==  (int32_t)3)) {
...
for (uint32_t i =  (int32_t)0; i < m; i++){
for (uint32_t j =  (int32_t)0; j < m; j++){
Arr6DIdxRowM(outputTiles,CO,CI,TH,TW,m,m,i2,i3,th,tw,i,j) = Arr2DIdxRowM(outputTransformed,m,m,i,j);
}
}
...
for (uint32_t i =  (int32_t)0; i < m; i++){
for (uint32_t j =  (int32_t)0; j < m; j++){
Arr5DIdxRowM(reducedTiles,CO,TH,TW,m,m,i2,th,tw,i,j) = Arr6DIdxRowM(outputTiles,CO,CI,TH,TW,m,m,i2, (int32_t)0,th,tw,i,j);
for (uint32_t i3 =  (int32_t)1; i3 < CI; i3++){
Arr5DIdxRowM(reducedTiles,CO,TH,TW,m,m,i2,th,tw,i,j) = SecretAdd(Arr5DIdxRowM(reducedTiles,CO,TH,TW,m,m,i2,th,tw,i,j), Arr6DIdxRowM(outputTiles,CO,CI,TH,TW,m,m,i2,i3,th,tw,i,j));
}
}
}
}
...
Arr4DIdxRowM(outArr,N,((((H + zPadHLeft) + zPadHRight) - r) +  (int32_t)1),((((W + zPadWLeft) + zPadWRight) - r) +  (int32_t)1),CO, (int32_t)0,indH,indW,i2) = Arr5DIdxRowM(reducedTiles,CO,TH,TW,m,m,i2,th,tw,i,j);
}
}
}
}
...
void Conv2DWinoMultipleCOT(int32_t m, int32_t r, int32_t N, int32_t H, int32_t W, int32_t CI, int32_t CO, int32_t zPadHLeft, int32_t zPadHRight, int32_t zPadWLeft, int32_t zPadWRight, uint64_t* inputArr, uint64_t* transformedFilter, uint64_t* outArr){
...
uint64_t* mul1 = make_array<uint64_t>(s1, s2, s3);

uint64_t* mul2 = make_array<uint64_t>(s1, s2, s3);

uint64_t* mulout = make_array<uint64_t>(s1, s2, s3);
for (uint32_t co =  (int32_t)0; co < CO; co++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
for (uint32_t ci =  (int32_t)0; ci < CI; ci++){
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr3DIdxRowM(mul1,s1,s2,s3,co,((th * TW) + tw),((((ci * n) * n) + (i * n)) + j)) = Arr6DIdxRowM(inputTiles,N,CI,TH,TW,n,n, (int32_t)0,ci,th,tw,i,j);
Arr3DIdxRowM(mul2,s1,s2,s3,co,((th * TW) + tw),((((ci * n) * n) + (i * n)) + j)) = Arr4DIdxRowM(transformedFilter,((m + r) -  (int32_t)1),((m + r) -  (int32_t)1),CI,CO,i,j,ci,co);
}
}
}
}
...
uint64_t* mat = make_array<uint64_t>(s2, s3);

uint64_t* vec = make_array<uint64_t>(s3,  (int32_t)1);

uint64_t* res = make_array<uint64_t>(s2, s3);
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr2DIdxRowM(vec,s3, (int32_t)1,k, (int32_t)0) = Arr3DIdxRowM(mul2,s1,s2,s3,i, (int32_t)0,k);
}
for (uint32_t j =  (int32_t)0; j < s2; j++){
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr2DIdxRowM(mat,s2,s3,j,k) = Arr3DIdxRowM(mul1,s1,s2,s3,i,j,k);
}
}
WinogradHadamard(s2, s3,  (int32_t)1, mat, vec, res, 0);
for (uint32_t j =  (int32_t)0; j < s2; j++){
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr3DIdxRowM(mulout,s1,s2,s3,i,j,k) = Arr2DIdxRowM(res,s2,s3,j,k);
}
}
}
...
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(outputBlock,n,n,i,j) = Arr3DIdxRowM(mulout,s1,s2,s3,i2,((th * TW) + tw),((((i3 * n) * n) + (i * n)) + j));
}
}
if ((r ==  (int32_t)3)) {
WinogradM4R3OutputTransform(outputBlock, outputTransformed);
...
void Conv2DWinoWrong(int32_t m, int32_t r, int32_t N, int32_t H, int32_t W, int32_t CI, int32_t CO, int32_t zPadHLeft, int32_t zPadHRight, int32_t zPadWLeft, int32_t zPadWRight, uint64_t* inputArr, uint64_t* transformedFilter, uint64_t* outArr){
...
uint64_t* mul2 = make_array<uint64_t>(s2, s3);

uint64_t* reducedMul = make_array<uint64_t>(s1, s3);
for (uint32_t co =  (int32_t)0; co < CO; co++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
for (uint32_t ci =  (int32_t)0; ci < CI; ci++){
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(mul1,s1,s2,((((co * TH) * TW) + (th * TW)) + tw),ci) = Arr6DIdxRowM(inputTiles,N,CI,TH,TW,n,n, (int32_t)0,ci,th,tw,i,j);
Arr2DIdxRowM(mul2,s2,s3,ci,((i * n) + j)) = Arr4DIdxRowM(transformedFilter,((m + r) -  (int32_t)1),((m + r) -  (int32_t)1),CI,CO,i,j,ci,co);
}
}
}
}
...
MatMul2D(s1, s2, s3, mul1, mul2, reducedMul, 0);
ClearMemSecret6(N, CI, TH, TW, n, n, inputTiles);
ClearMemSecret2(s1, s2, mul1);
...
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(outputBlock,n,n,i,j) = Arr2DIdxRowM(reducedMul,s1,s3,((((i2 * TH) * TW) + (th * TW)) + tw),((i * n) + j));
}
}
if ((r ==  (int32_t)3)) {
WinogradM4R3OutputTransform(outputBlock, outputTransformed);
...
indW = ((tw * m) + j);
if (((indH < outH) && (indW < outW))) {
Arr4DIdxRowM(outArr,N,((((H + zPadHLeft) + zPadHRight) - r) +  (int32_t)1),((((W + zPadWLeft) + zPadWRight) - r) +  (int32_t)1),CO, (int32_t)0,indH,indW,i2) = Arr2DIdxRowM(outputTransformed,m,m,i,j);
}
}
}
ClearMemSecret2(n, n, outputBlock);
...
void Conv2DWinoDW(int32_t m, int32_t r, int32_t N, int32_t H, int32_t W, int32_t C, int32_t zPadHLeft, int32_t zPadHRight, int32_t zPadWLeft, int32_t zPadWRight, uint64_t* inputArr, uint64_t* transformedFilter, uint64_t* outArr){
...
uint64_t* truInputImg = make_array<uint64_t>(N, C, truH, truW);
for (uint32_t i1 =  (int32_t)0; i1 < N; i1++){
for (uint32_t i2 =  (int32_t)0; i2 < C; i2++){
for (uint32_t i3 =  (int32_t)0; i3 < truH; i3++){
for (uint32_t i4 =  (int32_t)0; i4 < truW; i4++){
if (((((zPadHLeft <= i3) && (i3 < (zPadHLeft + H))) && (zPadWLeft <= i4)) && (i4 < (zPadWLeft + W)))) {
Arr4DIdxRowM(truInputImg,N,C,truH,truW,i1,i2,i3,i4) = Arr4DIdxRowM(inputArr,N,H,W,C,i1,(i3 - zPadHLeft),(i4 - zPadWLeft),i2);
} else {
Arr4DIdxRowM(truInputImg,N,C,truH,truW,i1,i2,i3,i4) = funcSSCons( (int64_t)0);
}
}
}
}
...
uint64_t* inputTiles = make_array<uint64_t>(N, C, TH, TW, n, n);
for (uint32_t i1 =  (int32_t)0; i1 < N; i1++){
for (uint32_t i2 =  (int32_t)0; i2 < C; i2++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
...
indW = ((tw * m) + j);
if (((indH < truH) && (indW < truW))) {
Arr2DIdxRowM(inputBlock,n,n,i,j) = Arr4DIdxRowM(truInputImg,N,C,truH,truW,i1,i2,indH,indW);
} else {
Arr2DIdxRowM(inputBlock,n,n,i,j) = funcSSCons( (int64_t)0);
}
}
...
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr6DIdxRowM(inputTiles,N,C,TH,TW,n,n,i1,i2,th,tw,i,j) = Arr2DIdxRowM(inputTransformed,n,n,i,j);
}
}
ClearMemSecret2(n, n, inputBlock);
ClearMemSecret2(n, n, inputTransformed);
...
uint64_t* mul1 = make_array<uint64_t>(s2, s3);

uint64_t* mul2 = make_array<uint64_t>(s2, s3);

uint64_t* mulout = make_array<uint64_t>(s2, s3);
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
for (uint32_t c =  (int32_t)0; c < C; c++){
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(mul1,s2,s3,((th * TW) + tw),((((c * n) * n) + (i * n)) + j)) = Arr6DIdxRowM(inputTiles,N,C,TH,TW,n,n, (int32_t)0,c,th,tw,i,j);
Arr2DIdxRowM(mul2,s2,s3,((th * TW) + tw),((((c * n) * n) + (i * n)) + j)) = Arr4DIdxRowM(transformedFilter,((m + r) -  (int32_t)1),((m + r) -  (int32_t)1), (int32_t)1,C,i,j, (int32_t)0,c);
}
}
}
}
...
uint64_t* res = make_array<uint64_t>(s2, s3);
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr2DIdxRowM(vec,s3, (int32_t)1,k, (int32_t)0) = Arr2DIdxRowM(mul2,s2,s3, (int32_t)0,k);
}
for (uint32_t j =  (int32_t)0; j < s2; j++){
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr2DIdxRowM(mat,s2,s3,j,k) = Arr2DIdxRowM(mul1,s2,s3,j,k);
}
}
...
for (uint32_t j =  (int32_t)0; j < s2; j++){
for (uint32_t k =  (int32_t)0; k < s3; k++){
Arr2DIdxRowM(mulout,s2,s3,j,k) = Arr2DIdxRowM(res,s2,s3,j,k);
}
}
ClearMemSecret2(s2, s3, mat);
ClearMemSecret2(s3,  (int32_t)1, vec);
ClearMemSecret2(s2, s3, res);

uint64_t* outputTiles = make_array<uint64_t>(C, TH, TW, m, m);
for (uint32_t i3 =  (int32_t)0; i3 < C; i3++){
for (uint32_t th =  (int32_t)0; th < TH; th++){
for (uint32_t tw =  (int32_t)0; tw < TW; tw++){
...
for (uint32_t i =  (int32_t)0; i < n; i++){
for (uint32_t j =  (int32_t)0; j < n; j++){
Arr2DIdxRowM(outputBlock,n,n,i,j) = Arr2DIdxRowM(mulout,s2,s3,((th * TW) + tw),((((i3 * n) * n) + (i * n)) + j));
}
}
if ((r ==  (int32_t)3)) {
WinogradM4R3OutputTransform(outputBlock, outputTransformed);
...
for (uint32_t i =  (int32_t)0; i < m; i++){
for (uint32_t j =  (int32_t)0; j < m; j++){
Arr5DIdxRowM(outputTiles,C,TH,TW,m,m,i3,th,tw,i,j) = Arr2DIdxRowM(outputTransformed,m,m,i,j);
}
}
ClearMemSecret2(n, n, outputBlock);
ClearMemSecret2(m, m, outputTransformed);
...
indW = ((tw * m) + j);
if (((indH < outH) && (indW < outW))) {
Arr4DIdxRowM(outArr,N,((((H + zPadHLeft) + zPadHRight) - r) +  (int32_t)1),((((W + zPadWLeft) + zPadWRight) - r) +  (int32_t)1),C, (int32_t)0,indH,indW,i2) = Arr5DIdxRowM(outputTiles,C,TH,TW,m,m,i2,th,tw,i,j);
}
}
}
}
...
void Conv2DWinoWrapper(int32_t m, int32_t r, int32_t N, int32_t H, int32_t W, int32_t CI, int32_t CO, int32_t zPadHLeft, int32_t zPadHRight, int32_t zPadWLeft, int32_t zPadWRight, int32_t G, uint64_t* inputArr, uint64_t* transformedFilter, uint64_t* outArr){
if ((G == CI)) {
...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)3,  (int32_t)8,  (int32_t)8);
/* Variable to read the clear value corresponding to the input variable tmp0 at (10147,1-10147,42) */
uint64_t __tmp_in_tmp0;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)3; i1++){
for (uint32_t i2 =  (uint32_t)0; i2 <  (int32_t)8; i2++){
for (uint32_t i3 =  (uint32_t)0; i3 <  (int32_t)8; i3++){
if ((party == CLIENT)) {
__tmp_in_tmp0 = rand() ;
}
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)3, (int32_t)8, (int32_t)8,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)3,  (int32_t)1,  (int32_t)6,  (int32_t)6);
/* Variable to read the clear value corresponding to the input variable tmp1 at (10150,1-10150,42) */
...
Arr4DIdxRowM(tmp1, (int32_t)3, (int32_t)1, (int32_t)6, (int32_t)6,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}
...
/* Variable to read the clear value corresponding to the input variable tmp2 at (10153,1-10153,33) */
...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)3);
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)8; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)8; i6++){
Arr4DIdxRowM(tmp3, (int32_t)1, (int32_t)8, (int32_t)8, (int32_t)3,i4,i5,i6,i7) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)3, (int32_t)8, (int32_t)8,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)8)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)6,  (int32_t)6,  (int32_t)1,  (int32_t)3);
...
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)6; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)6; i13++){
Arr4DIdxRowM(tmp4, (int32_t)6, (int32_t)6, (int32_t)1, (int32_t)3,i12,i13,i14,i15) = Arr4DIdxRowM(tmp1, (int32_t)3, (int32_t)1, (int32_t)6, (int32_t)6,i8,i9,i10,i11);
i11 = (i11 +  (int64_t)1);
if ((i11 ==  (int64_t)6)) {
i11 =  (int64_t)0;
i10 = (i10 +  (int64_t)1);
...
Conv2DWinoWrapper( (int32_t)2,  (int32_t)5,  (int32_t)1,  (int32_t)8,  (int32_t)8,  (int32_t)3,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)3, tmp3, tmp4, tmp5);
