...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)1,  (int32_t)44,  (int32_t)44,  (int32_t)3);
Conv2DWinoWrapper( (int32_t)4,  (int32_t)3,  (int32_t)1,  (int32_t)46,  (int32_t)46,  (int32_t)3,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1, tmp3, tmp4, tmp5);
...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)44,  (int32_t)44,  (int32_t)3);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)44; i1++){
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)44; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)3; i3++){
Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)44, (int32_t)44, (int32_t)3,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp5, (int32_t)1, (int32_t)44, (int32_t)44, (int32_t)3,i0,i1,i2,i3), Arr4DIdxRowM(tmp6, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)3,i0, (int32_t)0, (int32_t)0,i3));
}
}
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)3,  (int32_t)44,  (int32_t)44);
...
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)44; i27++){
for (uint32_t i28 =  (int32_t)0; i28 <  (int32_t)44; i28++){
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)3; i26++){
Arr4DIdxRowM(tmp8, (int32_t)1, (int32_t)3, (int32_t)44, (int32_t)44,i25,i26,i27,i28) = Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)44, (int32_t)44, (int32_t)3,i21,i22,i23,i24);
i24 = (i24 +  (int64_t)1);
if ((i24 ==  (int64_t)3)) {
i24 =  (int64_t)0;
i23 = (i23 +  (int64_t)1);
...
ScaleDown4( (int32_t)1,  (int32_t)3,  (int32_t)44,  (int32_t)44, tmp8,  (int32_t)23);
EndComputation();
}
