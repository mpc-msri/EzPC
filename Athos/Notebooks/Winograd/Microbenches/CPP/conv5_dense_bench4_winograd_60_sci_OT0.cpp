...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)256,  (int32_t)256);
/* Variable to read the clear value corresponding to the input variable tmp0 at (10147,1-10147,47) */
...
Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)256, (int32_t)256,i0,i1,i2,i3) = (party == CLIENT) ? __tmp_in_tmp0 : 0;
}
}
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)64,  (int32_t)64,  (int32_t)6,  (int32_t)6);
/* Variable to read the clear value corresponding to the input variable tmp1 at (10150,1-10150,44) */
...
Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)64, (int32_t)6, (int32_t)6,i0,i1,i2,i3) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}
}
}
...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)256,  (int32_t)256,  (int32_t)64);
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)64; i7++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
Arr4DIdxRowM(tmp3, (int32_t)1, (int32_t)256, (int32_t)256, (int32_t)64,i4,i5,i6,i7) = Arr4DIdxRowM(tmp0, (int32_t)1, (int32_t)64, (int32_t)256, (int32_t)256,i0,i1,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)256)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)6,  (int32_t)6,  (int32_t)64,  (int32_t)64);
...
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)64; i14++){
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)6; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)6; i13++){
Arr4DIdxRowM(tmp4, (int32_t)6, (int32_t)6, (int32_t)64, (int32_t)64,i12,i13,i14,i15) = Arr4DIdxRowM(tmp1, (int32_t)64, (int32_t)64, (int32_t)6, (int32_t)6,i8,i9,i10,i11);
i11 = (i11 +  (int64_t)1);
if ((i11 ==  (int64_t)6)) {
i11 =  (int64_t)0;
i10 = (i10 +  (int64_t)1);
...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)1,  (int32_t)252,  (int32_t)252,  (int32_t)64);
Conv2DWinoWrapper( (int32_t)2,  (int32_t)5,  (int32_t)1,  (int32_t)256,  (int32_t)256,  (int32_t)64,  (int32_t)64,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1, tmp3, tmp4, tmp5);

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64);
...
Arr4DIdxRowM(tmp6, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i17,i18,i19,i20) = Arr1DIdxRowM(tmp2, (int32_t)64,i16);
i16 = (i16 +  (int64_t)1);
}
}
}
}
ScaleUp4( (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)64, tmp6,  (int32_t)23);

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)252,  (int32_t)252,  (int32_t)64);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)252; i1++){
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)252; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)64; i3++){
Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)252, (int32_t)252, (int32_t)64,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp5, (int32_t)1, (int32_t)252, (int32_t)252, (int32_t)64,i0,i1,i2,i3), Arr4DIdxRowM(tmp6, (int32_t)1, (int32_t)1, (int32_t)1, (int32_t)64,i0, (int32_t)0, (int32_t)0,i3));
}
}
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)1,  (int32_t)64,  (int32_t)252,  (int32_t)252);
...
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)252; i27++){
for (uint32_t i28 =  (int32_t)0; i28 <  (int32_t)252; i28++){
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)64; i26++){
Arr4DIdxRowM(tmp8, (int32_t)1, (int32_t)64, (int32_t)252, (int32_t)252,i25,i26,i27,i28) = Arr4DIdxRowM(tmp7, (int32_t)1, (int32_t)252, (int32_t)252, (int32_t)64,i21,i22,i23,i24);
i24 = (i24 +  (int64_t)1);
if ((i24 ==  (int64_t)64)) {
i24 =  (int64_t)0;
i23 = (i23 +  (int64_t)1);
...
ScaleDown4( (int32_t)1,  (int32_t)64,  (int32_t)252,  (int32_t)252, tmp8,  (int32_t)23);
EndComputation();
}
