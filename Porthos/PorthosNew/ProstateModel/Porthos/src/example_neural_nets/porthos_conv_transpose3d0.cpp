...
auto tmp0 = make_vector<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1);
...
auto tmp1 = make_vector<uint64_t>( (int32_t)2,  (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)1);
...
auto tmpimg = make_vector<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1);
auto tmpweights = make_vector<uint64_t>( (int32_t)2,  (int32_t)3,  (int32_t)3,  (int32_t)1,  (int32_t)1);
...
auto tmpoutput = make_vector<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1);
ConvTranspose3DLoop( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)2,  (int32_t)3,  (int32_t)3,  (int32_t)1, (int32_t)2,  (int32_t)5,  (int32_t)5,   (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmpimg, tmpweights, tmpoutput);
...
for (uint32_t i3 =  (uint32_t)0; i3 <  (int32_t)5; i3++){
for (uint32_t i4 =  (uint32_t)0; i4 <  (int32_t)1; i4++){
cout << (int64_t)(funcReconstruct2PCCons((tmpoutput[i0][i1][i2][i3][i4])>>24, 2)) << endl;
}
}
}
}
...
auto tmp2 = make_vector<uint64_t>( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1);
ConvTranspose3DCSFMPC( (int32_t)1,  (int32_t)2,  (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)2,  (int32_t)3,  (int32_t)3,  (int32_t)1, (int32_t)2,  (int32_t)5,  (int32_t)5,   (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp0, tmp1,  (int32_t)24, tmp2);
