...
class Operator:
    ...
    @classmethod
    def BatchNormalization(cls, attributes, inputs, outputs, value_info, var_dict, mode, indent):
    ...
    @classmethod
    def GlobalAveragePool(cls, attributes, inputs, outputs, value_info, var_dict, mode, indent):
    ...
    def Gemm(cls, attributes, inputs, outputs, value_info, var_dict, mode, indent):
        ...
        return str(
            f"{'   ' * indent}new FC<T>(" f"{inn}, {out}{isBias}" f");")
        # ) + cls.Truncate(
        #     attributes, inputs, outputs, value_info, var_dict, mode, indent
        # )
